...
@implementation MLKeywordConstraint

+ (MLKeywordConstraint *) key:(NSString *) keyName equals:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
	constraint.dict = [NSMutableDictionary 
                        dictionaryWithObject:
                            [NSMutableDictionary dictionaryWithObjects:[NSArray arrayWithObjects:keyName, value, nil] 
                                                               forKeys:[NSArray arrayWithObjects:@"constraint-name", @"text", nil] ] 
                        forKey:@"value-constraint-query"];
                       
	return constraint;
}

+ (MLKeywordConstraint *) key:(NSString *) keyName contains:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
	constraint.dict = [NSMutableDictionary 
                       dictionaryWithObject:
                       [NSMutableDictionary dictionaryWithObjects:[NSArray arrayWithObjects:keyName, value, nil] 
                                                          forKeys:[NSArray arrayWithObjects:@"constraint-name", @"text", nil] ] 
                       forKey:@"word-constraint-query"];
    
	return constraint;
}

+ (MLKeywordConstraint *) element:(NSString *) elementName equals:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
	constraint.dict = [NSMutableDictionary 
                       dictionaryWithObject:
                       [NSMutableDictionary dictionaryWithObjects:[NSArray arrayWithObjects:elementName, value, nil] 
                                                          forKeys:[NSArray arrayWithObjects:@"constraint-name", @"text", nil] ] 
                       forKey:@"value-constraint-query"];
...
+ (MLKeywordConstraint *) element:(NSString *) elementName contains:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
	constraint.dict = [NSMutableDictionary 
                       dictionaryWithObject:
                       [NSMutableDictionary dictionaryWithObjects:[NSArray arrayWithObjects:elementName, value, nil] 
                                                          forKeys:[NSArray arrayWithObjects:@"constraint-name", @"value", nil] ] 
                       forKey:@"word-constraint-query"];
    return constraint;
}

/*
+ (MLKeywordConstraint *) attribute:(NSString *) attributeName onElement:(NSString *) elementName equals:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
...
+ (MLKeywordConstraint *) attribute:(NSString *) attributeName onElement:(NSString *) elementName contains:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
...
+ (MLKeywordConstraint *) property:(NSString *) propertyName equals:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
...
+ (MLKeywordConstraint *) property:(NSString *) propertyName contains:(NSString *) value {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
...
+ (MLKeywordConstraint *) wordAnywhere:(NSString *) word {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
	constraint.dict = [NSMutableDictionary dictionaryWithObject:word forKey:@"wordAnywhere"];
	return constraint;
}

+ (MLKeywordConstraint *) wordInBinary:(NSString *) word {
	MLKeywordConstraint *constraint = [[[MLKeywordConstraint alloc] init] autorelease];
